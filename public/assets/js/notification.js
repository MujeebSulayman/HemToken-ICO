...
var countries = ['eng', 'us', 'eng_flage', 'fn', 'frn_flage'];
...
function notification() {
    spop({
        template: '<div class="sale_notification d-flex align-items-center"> <div class="notification_inner"> <h3>' + Math.floor(Math.random() * 4 ) +  'MTK</h3><p>Sold in <img src="assets/images/' + countries[Math.floor(Math.random() * 7)] + '.png" alt="" /></p></div></div>',
        group: 'submit-satus',
